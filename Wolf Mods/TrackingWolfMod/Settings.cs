    ...
    internal class TrackingWolfSettings : TypeSpecificSettings
    {
        ...
        public override bool CanSpawn(BaseAi ai)
        {
            return Enable
                ...
                && (!ForceSpawn || (ForceSpawn && EAFManager.Instance.DataManager.CanForceSpawn(ai.m_WildlifeMode, typeof(TrackingWolf)))); //If force spawn IS enabled, then there must also be room for force spawning!
        }
