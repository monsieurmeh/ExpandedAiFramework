...
namespace ExpandedAiFramework
{
    public class CustomSpawnRegion : ILogInfoProvider
    {
        ...
        private void SetBoundingSphereBasedOnWaypoints(int waypointIndex)
        {
            ...
            {
                this.LogTraceInstanced($"Invalid waypoint index !_{waypointIndex}_! (waypoints available: !_{mSpawnRegion?.m_PathManagers?.Length ?? 0}_!)");
                return;
            }
        ...
        private void AdjustActiveSpawnRegionPopulation()
        {
            ...
            if (targetDelta > 0)
            {
                ...
                if (targetDelta <= 0)
                {
                    this.LogTraceInstanced($"numToActivate (!_{targetDelta}_!) invalid, aborting");
                    return;
                }
        ...
        private bool RespawnAllowed()
        {
            ...
            this.LogTraceInstanced($"Respawn allowed");
            return true;
        }
